Feature: Played cards can be face up or face down
  ...
  As a player
  I want to see face down played cards until all players have played the round

  Scenario: Other's cards are face down
    Given I am playing a round with one other player
